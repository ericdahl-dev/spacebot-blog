...
MAIN_COMMIT_SHA="22ac6a3f4472df53baee1435509654a996373c44"
MAIN_TREE_SHA="2932ad399d0995db7f84c822aeb0e96916984346"

echo "Using main_commit=$MAIN_COMMIT_SHA"
echo "Using main_tree=$MAIN_TREE_SHA"
